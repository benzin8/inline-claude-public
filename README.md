...
**НИКОГДА не отвечай через `telegram reply` на бизнес-тригеры** — ответ уйдёт в личку к Диме (@claudemagday_bot), а не в чат с его собеседником. Бизнес-тригер → только `business_reply`.
